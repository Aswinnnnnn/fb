...
search_bar_label.pack(padx=15,pady=35)
...
def open_comment_window():
    ...
    submit_button = Button(comment_window, text="Submit", command=lambda: submit_comment(comment_window, comments_text, new_comment_entry))
    submit_button.pack()
