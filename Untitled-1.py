...
# Post information
post_dates = ["12 Feb 2022", "29 February 2022", "19 December 2022"]
...
def open_comment_window(post_id):
    ...
    commentbox_image_frame = Frame(comment_window, bg="white")
    commentbox_image_frame.pack(side=TOP, fill=X)

    image = Image.open(post_images[post_id]).convert("RGB")
    resized_image = image.resize((920,540))

    post_image = ImageTk.PhotoImage(resized_image)

    # Create a label for the post image
    commentbox_image_label = Label(commentbox_image_frame, image=post_image, bg="white")
    commentbox_image_label.image = post_image
    commentbox_image_label.pack(side=TOP)
    ...
    submit_button = Button(comment_window, image=send_comment_image, command=lambda: submit_comment(comment_window, comments_text, new_comment_entry, post_id))
    submit_button.pack()


# Define a function to submit a new comment for a post
def submit_comment(comment_window, comments_text, new_comment_entry, post_id):
    ...
    if new_comment.strip():
        ...
        if is_palindrome_flag:
            ...
            comments.append((post_id, new_comment))
...
# Define a function to change Image and open a comment window for the post
def change_img(img1, post_id):
    new_image = like_fill_button
    img1.configure(image=new_image)
    img1.image = new_image
...
#POST 1
Tempframe1 = Frame(posts_frame_canvas,bg="white")
Tempframe1.pack(side=TOP,fill=X)
...
profile_frame = Frame(Tempframe1, bg="white", height=20)
profile_frame.pack(side=TOP,fill=X)
...
date_label = Label(user_name_date_frame, text=post_dates[0], font=("Segoe UI", 20), fg="grey", bg="white")
date_label.pack(side=TOP)

# Create a frame for the like and comment buttons
post_caption_frame = Frame(Tempframe1, bg="white", height=100)
post_caption_frame.pack(side=TOP, fill=X)

# Create a like button
post_caption_label = Label(post_caption_frame, text=post_captions[0], font=("Segoe UI", 25), fg="black", bg="white", bd=0, padx=5)
post_caption_label.pack(side=LEFT)

# Create a frame for the post image
post_image_frame = Frame(Tempframe1, bg="white")
post_image_frame.pack(side=TOP, fill=X)

image = Image.open(post_images[0]).convert("RGB")
...
# Create a frame for the like and comment buttons
post_buttons_frame = Frame(Tempframe1, bg="white", height=100)
...
like_button = Button(post_buttons_frame, text="Like", font=("Segoe UI", 14), fg="#FF0800", bg="white", bd=0, command=lambda: change_img(like_image_label, 0))
...
comment_button = Button(post_buttons_frame, text="Comment", font=("Segoe UI", 14), fg="#19BDFF", bg="white", bd=0 , command=open_comment_window(0))
comment_button.pack(side=LEFT, padx=5)

comment_count = Label(post_buttons_frame, text="comments")

posts_gap_label = Label(Tempframe1, text="", font=("Segoe UI", 16), padx=20, pady=10)
posts_gap_label.pack(side=TOP)

#POST 2
Tempframe2 = Frame(posts_frame_canvas,bg="white")
Tempframe1.pack(side=TOP,fill=X)

# Create a frame for the user photo and user name and date
#profile_frame = Frame(posts_frame_canvas, padx=20, pady=10, bg="white", highlightbackground="#ddd", highlightthickness=1)
profile_frame = Frame(Tempframe2, bg="white", height=20)
profile_frame.pack(side=TOP,fill=X)
...
date_label = Label(user_name_date_frame, text=post_dates[1], font=("Segoe UI", 20), fg="grey", bg="white")
date_label.pack(side=TOP)

# Create a frame for the like and comment buttons
post_caption_frame = Frame(Tempframe2, bg="white", height=100)
post_caption_frame.pack(side=TOP, fill=X)

# Create a like button
post_caption_label = Label(post_caption_frame, text=post_captions[1], font=("Segoe UI", 25), fg="black", bg="white", bd=0, padx=5)
post_caption_label.pack(side=LEFT)

# Create a frame for the post image
post_image_frame = Frame(Tempframe2, bg="white")
post_image_frame.pack(side=TOP, fill=X)

image = Image.open(post_images[1]).convert("RGB")
resized_image = image.resize((1928,1080))
...
# Create a frame for the like and comment buttons
post_buttons_frame = Frame(Tempframe2, bg="white", height=100)
post_buttons_frame.pack(side=TOP, fill=X)
...
#like_button = Button(post_buttons_frame, text="Like", font=("Segoe UI", 14), fg="#FF0800", bg="white", bd=0, command=change_img)
#like_button = Button(post_buttons_frame, text="Like", font=("Segoe UI", 14), fg="#FF0800", bg="white", bd=0, command=lambda post_index=i: change_img(post_index))
like_button = Button(post_buttons_frame, text="Like", font=("Segoe UI", 14), fg="#FF0800", bg="white", bd=0, command=lambda: change_img(like_image_label, 1))
like_button.pack(side=LEFT)
...
# Create a comment button
comment_button = Button(post_buttons_frame, text="Comment", font=("Segoe UI", 14), fg="#19BDFF", bg="white", bd=0 , command=open_comment_window(1))
comment_button.pack(side=LEFT, padx=5)

comment_count = Label(post_buttons_frame, text="comments")

posts_gap_label = Label(Tempframe2, text="", font=("Segoe UI", 16), padx=20, pady=10)
posts_gap_label.pack(side=TOP)

#POST 3
Tempframe3 = Frame(posts_frame_canvas,bg="white")
Tempframe3.pack(side=TOP,fill=X)

# Create a frame for the user photo and user name and date
#profile_frame = Frame(posts_frame_canvas, padx=20, pady=10, bg="white", highlightbackground="#ddd", highlightthickness=1)
profile_frame = Frame(Tempframe3, bg="white", height=20)
profile_frame.pack(side=TOP,fill=X)
...
date_label = Label(user_name_date_frame, text=post_dates[2], font=("Segoe UI", 20), fg="grey", bg="white")
date_label.pack(side=TOP)

# Create a frame for the like and comment buttons
post_caption_frame = Frame(Tempframe3, bg="white", height=100)
post_caption_frame.pack(side=TOP, fill=X)

# Create a like button
post_caption_label = Label(post_caption_frame, text=post_captions[2], font=("Segoe UI", 25), fg="black", bg="white", bd=0, padx=5)
post_caption_label.pack(side=LEFT)

# Create a frame for the post image
post_image_frame = Frame(Tempframe3, bg="white")
post_image_frame.pack(side=TOP, fill=X)

image = Image.open(post_images[2]).convert("RGB")
resized_image = image.resize((1928,1080))
...
# Create a frame for the like and comment buttons
post_buttons_frame = Frame(Tempframe3, bg="white", height=100)
post_buttons_frame.pack(side=TOP, fill=X)
...
#like_button = Button(post_buttons_frame, text="Like", font=("Segoe UI", 14), fg="#FF0800", bg="white", bd=0, command=change_img)
#like_button = Button(post_buttons_frame, text="Like", font=("Segoe UI", 14), fg="#FF0800", bg="white", bd=0, command=lambda post_index=i: change_img(post_index))
like_button = Button(post_buttons_frame, text="Like", font=("Segoe UI", 14), fg="#FF0800", bg="white", bd=0, command=lambda: change_img(like_image_label, 2))
like_button.pack(side=LEFT)
...
# Create a comment button
comment_button = Button(post_buttons_frame, text="Comment", font=("Segoe UI", 14), fg="#19BDFF", bg="white", bd=0 , command=open_comment_window(2))
comment_button.pack(side=LEFT, padx=5)

comment_count = Label(post_buttons_frame, text="comments")

posts_gap_label = Label(Tempframe3, text="", font=("Segoe UI", 16), padx=20, pady=10)
posts_gap_label.pack(side=TOP)
